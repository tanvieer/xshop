...
public class UserProfileServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			System.out.println("UserProfileServlet TEST BEFORE SESSION ON");
			HttpSession session = req.getSession(false);
			System.out.println("UserProfileServlet TEST AFTER SESSION ON");
			...
			if (session != null) {
				...
				System.out.println("UserProfileServlet NULL PAISE");
			...
			System.out.println("\n\n\n");
			System.out.println("UserProfileServlet " + e);

			System.out.println("UserProfileServlet EXCEPTION PAISE");
			resp.sendRedirect("user-login");
		}
