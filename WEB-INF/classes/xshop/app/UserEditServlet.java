...
public class UserEditServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		System.out.println("UserEditServlet "+ userid);
		System.out.println("UserEditServlet "+ pass);
		System.out.println("UserEditServlet "+ name);
		System.out.println("UserEditServlet "+ type);

		UserInfo user = new UserInfo(idd, userid, pass, name, type);
		System.out.println("UserEditServlet "+ new UserService().edit(user));
